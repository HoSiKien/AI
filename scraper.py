...
TECH_SOURCES = [
    {"name": "VnExpress - Công nghệ", "url": "https://vnexpress.net/rss/cong-nghe.rss", "type": "rss"},
    {"name": "GenK.vn", "url": "https://genk.vn/trangchu.rss", "type": "rss"},
    {"name": "Vietnam Insider - Tech", "url": "https://vietnaminsider.com/category/tech/feed/", "type": "rss"},
    {"name": "AgileTech Blog", "url": "https://agiletech.vn/feed/", "type": "rss"},
    {"name": "Bộ Khoa học Công nghệ", "url": "https://mst.gov.vn/rss-default.aspx", "type": "rss"},
    {"name": "Dân trí - Công nghệ", "url": "https://dantri.com.vn/cong-nghe.rss", "type": "rss"},
    {"name": "Zing News - Công nghệ", "url": "https://zingnews.vn/cong-nghe.rss", "type": "rss"},
    {"name": "VietNamNet - Công nghệ", "url": "https://vietnamnet.vn/rss/cong-nghe.rss", "type": "rss"},
]
    ...
    for source in TECH_SOURCES:
        if source['type'] == 'rss':
            ...
            for item in items:
                ...
                # Lấy tin trong 2 ngày gần nhất
                if (today - pub_date.date()).days <= 2:
                    # Lấy nội dung đầy đủ
                    raw_content = item['content'] if item['content'] else item['description']
                    if not raw_content:
                        continue
                    soup = BeautifulSoup(raw_content, 'html.parser')  # ĐẢM BẢO soup được khởi tạo ở đây
                    ...
                    print(f"  📰 {item['title'][:50]}... -> {len(content_text)} ký tự")
